...
final readonly class MaxHttpClient
{
     ...
     * @throws HttpException
     */
    public function patch(string $path, array $body, ?array $query = null): array
    {
     ...
     * @throws HttpException
     */
    public function post(string $path, array $body, ?array $query = null): array
    {
     ...
     * @throws HttpException
     */
    public function put(string $path, array $body, ?array $query = null): array
    {
