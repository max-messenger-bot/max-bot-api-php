...
final class MaxBot
{
    ...
    /**
     * Получает обновления с сервера через API и запускает процесс их обработки.
     *
    ...
    /**
     * Создаёт объект события на основе объекта обновления и запускает процесс обработки этого события.
     *
     * @return bool `true`, если событие считается обработанным.
     */
    ...
    /**
     * Создаёт объект события на основе объекта обновления.
     */
    ...
    /**
     * Создаёт объект обновления из JSON-стоки.
     */
