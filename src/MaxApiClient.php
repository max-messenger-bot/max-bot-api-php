...
use MaxMessenger\Bot\Uploaders\MaxSimpleUploader;
...
final class MaxApiClient
{
    ...
    public function getSimpleUploader(): MaxSimpleUploader
    {
        return new MaxSimpleUploader($this);
    }
    ...
    public function getUploader(): MaxUploader
    {
        return new MaxUploader($this);
    }
