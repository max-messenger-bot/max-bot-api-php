...
class Chat extends BaseResponseModel
{
    ...
    public function getIcon(): ?Image
    {
        return $this->icon === false
            ? ($this->icon = Image::newFromNullableData($this->data['icon']))
            : $this->icon;
    }
    ...
    /**
     * @return int Unix-time of last event occurred in chat (Unix timestamp in milliseconds).
     * @api
     */
    ...
    /**
     * @return ChatStatus|null Chat status. One of:
    ...
    /**
     * @return ChatType|null Type of chat.
     * @api
     */
