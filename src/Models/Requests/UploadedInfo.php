...
final class UploadedInfo extends BaseRequestModel
{
    ...
    /**
     * @param non-empty-string $token Token is unique uploaded media identifier (minLength: 1).
     * @api
     */
    ...
    /**
     * @param non-empty-string|null $token Token is unique uploaded media identifier (minLength: 1).
