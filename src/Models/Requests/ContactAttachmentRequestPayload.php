...
final class ContactAttachmentRequestPayload extends BaseRequestModel
{
    ...
    /**
     * @param non-empty-string|null $name Имя контакта (minLength: 1).
     * @param int|null $contactId ID контакта, если он зарегистрирован в MAX.
     * @param non-empty-string|null $vcfInfo Полная информация о контакте в формате VCF (minLength: 1).
     * @param non-empty-string|null $vcfPhone Телефон контакта в формате VCF (minLength: 1).
     * @api
     */
