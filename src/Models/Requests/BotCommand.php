...
final class BotCommand extends BaseRequestModel
{
    ...
    /**
     * @param non-empty-string $name Command name (minLength: 1, maxLength: 64).
     * @param non-empty-string|null $description Optional command description (minLength: 1, maxLength: 128).
     * @api
     */
    ...
    /**
     * @param non-empty-string|null $name Command name (minLength: 1, maxLength: 64).
