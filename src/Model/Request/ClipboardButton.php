...
final class ClipboardButton extends Button
{
     ...
     * @param non-empty-string|null $payload Текст, который будет скопирован (maxLength: 1024).
     */
     ...
     * @param non-empty-string $payload Текст, который будет скопирован (maxLength: 1024).
     */
