...
final class ChatAdmin extends BaseRequestModel
{
     ...
     *     в настройках чата или канала рядом с именем пользователя (minLength: 1). Если пользователь
     *     администратор или владелец и ему не установлено это название, то поле не передаётся,
     *     клиентское устройство на своей стороне подменит значение на соответствующее:
     *     "владелец" или "админ".
     */
