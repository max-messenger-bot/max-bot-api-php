...
{
    public HandlerListType $currentHandlerList = HandlerListType::Prepare;
    public ?HandlerListType $handledIn = null;
    public bool|null $isHandled = null;

    /**
     * @param list<Closure(Throwable $exception, BaseEvent $event): void> $exceptionHandlers
     */
    ...
    /**
     * @param Closure(static): void $handler Event handler.
     * @return bool True if the event has been processed and further processing should be stopped.
    ...
    public function handle(Closure $handler, ?bool $defaultIsHandled = null): bool
    {
        try {
            ...
            return $exception->isBreak();
        } catch (Throwable $exception) {
            /** @noinspection PhpUnhandledExceptionInspection */
            return $this->handleException($exception);
        }

        return $this->isHandled !== false;
    }
    ...
    protected function handleException(Throwable $exception): bool
    {
        ...
        foreach ($this->exceptionHandlers as $exceptionHandler) {
            ...
            try {
                $exceptionHandler($exception, $this);
            } catch (EventException $exception) {
                $this->isHandled = $exception->isBreak();
            }
