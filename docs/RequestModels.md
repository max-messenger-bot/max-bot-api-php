...
- ❌ [**CallbackAnswer**](../src/Models/Requests/CallbackAnswer.php) — Send this object when your bot wants to react to
...
- ❌ [**ContactAttachmentRequest**](../src/Models/Requests/ContactAttachmentRequest.php) — Request to attach contact card
  to message. MUST be the only attachment in message.
- ❌ [**ContactAttachmentRequestPayload**](../src/Models/Requests/ContactAttachmentRequestPayload.php) — Contact
  attachment payload.
- ❌ [**FileAttachmentRequest**](../src/Models/Requests/FileAttachmentRequest.php) — Request to attach file to message.
