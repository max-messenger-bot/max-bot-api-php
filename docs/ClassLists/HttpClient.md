...
- [**AccessTokenException**](../../src/HttpClient/Exceptions/AccessTokenException.php) — Исключение ошибки токена
  доступа.
- [**UnexpectedFormatException**](../../src/HttpClient/Exceptions/UnexpectedFormatException.php) — Исключение
  неожиданного
  формата ответа.
