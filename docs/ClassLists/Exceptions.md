...
- `src/Exceptions/` — Основные исключения библиотеки (27 классов)
    - `MaxBot/Events/` — Исключения событий бота
    - `MaxBot/Update/` — Исключения обновлений
    - `Uploaders/` — Исключения загрузчиков файлов
    - `Validation/` — Исключения валидации
- `src/HttpClient/Exceptions/` — Исключения HTTP-клиента (14 классов)
...
- **MaxBot** — Max Bot exceptions.
    ...
    - **Update** — Update-related exceptions.
        ...
        - ✅ [**UpdateRequestException**](../../src/Exceptions/MaxBot/Update/UpdateRequestException.php) (abstract) — Base class for update
          request exceptions.
- **Validation** — Validation exceptions.
    ...
    - ✅ [**RequiredOneFieldException**](../../src/Exceptions/Validation/RequiredOneFieldException.php) — At least one field must be
      non-null.
    - ✅ [**ValidationException**](../../src/Exceptions/Validation/ValidationException.php) (abstract) — Base class for validation
      exceptions.
- **HttpClient** — HTTP client exceptions.
    ...
    - **HttpResponse** — HTTP response exceptions.
        - **Http** — HTTP exceptions.
            ...
            - ✅ [**InternalHttpException**](../../src/HttpClient/Exceptions/HttpResponse/Http/InternalHttpException.php) — Внутренняя
              ошибка сервера.
            - ✅ [**MaxHttpException**](../../src/HttpClient/Exceptions/HttpResponse/Http/MaxHttpException.php) (abstract) — Базовый класс
              для HTTP-исключений Max API.
            ...
            - ✅ [**ServiceUnavailableException**](../../src/HttpClient/Exceptions/HttpResponse/Http/ServiceUnavailableException.php) —
              Сервис недоступен.
            - ✅ [**TooManyRequestsException**](../../src/HttpClient/Exceptions/HttpResponse/Http/TooManyRequestsException.php) — Превышено
              количество запросов.
            - ✅ [**UnauthorizedException**](../../src/HttpClient/Exceptions/HttpResponse/Http/UnauthorizedException.php) — Ошибка
              аутентификации.
...
- **Uploaders** — Загрузчики файлов.
    - ✅ [**StreamException**](../../src/Exceptions/Uploaders/StreamException.php) — Stream exception.
    - ✅ [**StreamLogicException**](../../src/Exceptions/Uploaders/StreamLogicException.php) — Stream logic exception.
    - ✅ [**UnknownDataFormatException**](../../src/Exceptions/Uploaders/UnknownDataFormatException.php) — Unknown data format.
    - ✅ [**UnknownErrorException**](../../src/Exceptions/Uploaders/UnknownErrorException.php) — Unknown error.
    - ✅ [**UploaderException**](../../src/Exceptions/Uploaders/UploaderException.php) (abstract) — Base class for uploader exceptions.
