...
$callbackHandler = new CallbackJsonHandler(actionKey: 'action');

// При нажатии кнопки с payload '{"action": "start", "data": "value"}':
// - $event->userData['__action'] = 'start'
// - $event->userData['__payload'] = ['action' => 'start', 'data' => 'value']
```
