...
4. **Обнови таблицу:**
    ...
    - Отсортируй таблицу по столбцу OperationId (алфавитный порядок)
...
- Таблица должна быть отсортирована по столбцу OperationId в алфавитном порядке
