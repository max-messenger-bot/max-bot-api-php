...
final class DialogClearedEventTest extends Unit
{
    ...
    private function createEvent(?string $userLocale = 'ru-RU'): DialogClearedEvent
    {
        $data = [
        ...
        self::assertInstanceOf(DialogClearedEvent::class, $event);
