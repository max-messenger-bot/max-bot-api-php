...
final class DialogRemovedEventTest extends Unit
{
    ...
    private function createEvent(?string $userLocale = 'ru-RU'): DialogRemovedEvent
    {
        $data = [
        ...
        self::assertInstanceOf(DialogRemovedEvent::class, $event);
