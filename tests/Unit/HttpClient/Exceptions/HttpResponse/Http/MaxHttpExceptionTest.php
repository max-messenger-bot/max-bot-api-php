...
namespace MaxMessenger\Bot\Tests\Unit\HttpClient\Exceptions\HttpResponse\Http;
...
use MaxMessenger\Bot\HttpClient\Exceptions\HttpResponse\Http\NotAllowedException;
use MaxMessenger\Bot\HttpClient\Exceptions\HttpResponse\Http\NotFoundException;
use MaxMessenger\Bot\HttpClient\Exceptions\HttpResponse\Http\ServiceUnavailableException;
use MaxMessenger\Bot\HttpClient\Exceptions\HttpResponse\Http\TooManyRequestsException;
use MaxMessenger\Bot\HttpClient\Exceptions\HttpResponse\Http\UnauthorizedException;
use MaxMessenger\Bot\HttpClient\Exceptions\HttpResponse\Http\UnknownException;
use MaxMessenger\Bot\HttpClient\Exceptions\HttpResponse\Http\UnsupportedMediaTypeException;
...
final class MaxHttpExceptionTest extends Unit
{
    ...
    public function testThrowMaxTooManyRequests(): void
    {
        ...
        $error = $this->createError('too.many.requests', 'Too Many Requests');
