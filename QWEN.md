...
│   │   ├── Uploaders/            # Интерфейсы загрузчиков
│   │   │   └── StreamInterface.php
...
│   │   ├── Uploaders/            # Исключения загрузчиков
...
│   │   ├── Contents/             # Содержимое для загрузки
│   │   ├── FragmentUploadStat.php
│   │   ├── MaxSimpleUploader.php
│   │   └── MaxUploader.php
...
### Исключения загрузчиков

Находятся в `Exceptions/Uploaders/`:

- `StreamException` — исключение потока
- `StreamLogicException` — ошибка логики потока
- `UnknownDataFormatException` — неизвестный формат данных
- `UnknownErrorException` — неизвестная ошибка
- `UploaderException` — базовый класс для исключений загрузчиков
